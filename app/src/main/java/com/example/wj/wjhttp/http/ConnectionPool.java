...
public class ConnectionPool {
    ...
    //创建一个线程池
    private static Executor executor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), new ThreadFactory() {
        @Override
        public Thread newThread(Runnable r) {
            //设置为守护线程
            Thread thread = new Thread(r,"this is ConnectionPool");
